...
var patterns = require('./module/patterns');
...
Agent.prototype.connect = function(transport, id) {
  ...
  if (Array.isArray(transport)) {
    ...
    // TODO: see how much overhead this gives with respect to binding to this.receive
    //       problem with binding is that you have a problem when receive is overloaded
    //       *after* the connection is made
    // var listener = this.receive.bind(this);
    var listener = function (from, message) {
      me.receive(from, message)
    };
    return transport
