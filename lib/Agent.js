 ...
 *                transport via the last connected transport.
 *              - A string "agentId@transportId"
 *              - A string "protocol://networkId/agentId"
...
Agent.prototype.send = function(to, message) {
  ...
  if (colon != -1) {
    ...
    throw new Error('Support for urls not yet implemented...');
  }
  ...
  if (at != -1) {
    ...
    return this._sendTransport(_transportId, _to, message);
  }
 ...
 * @private
 */
Agent.prototype._sendTransport = function(transportId, to, message) {
