 ...
 *                                onConnect()
 */
PubNubMessageBus.prototype.register = function register (id, onMessage, onConnect) {
 ...
 * @param {String} id
 */
PubNubMessageBus.prototype.unregister = function unregister (id) {
  this.pubnub.unsubscribe(id);
};
