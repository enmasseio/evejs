 ...
 */
function patternize(object, params) {
  var receiveName = params && params.receive || 'receive';
  var receiveOriginal = object.hasOwnProperty(receiveName) ? object[receiveName] : null;
  var listeners = [];
   ...
   */
  object.receive = function(from, message) {
