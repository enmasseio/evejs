 ...
 *                                              connected.
 */
PubNubTransport.prototype.connect = function connect (id, onMessage) {
  var me = this;
 ...
 * @param {String} id
 */
PubNubTransport.prototype.disconnect = function disconnect (id) {
 ...
 */
PubNubTransport.prototype.send = function send (from, to, message) {
  this.pubnub.publish({
    channel: to,
    message: {
      from: from,
